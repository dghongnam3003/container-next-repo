    ...
    <div className="max-w-4xl mx-auto p-6 space-y-8">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        ...
        <button
          ...
          className="bg-blue-500 text-white px-6 py-2 rounded-md hover:bg-blue-600 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors duration-200"
        >
          Create Token
        </button>
      </div>
